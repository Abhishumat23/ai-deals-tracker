"""
Scraper for https://www.anthropic.com/pricing
Extracts Claude plan pricing strictly using dynamic DOM extraction.
"""
...
EXPECTED_TIERS = ["Free", "Pro", "Team", "Max"]

ANCHORS = {
    "Free": "free for everyone",
    "Pro": "for everyday productivity",
    "Team": "for teams of 5 to 150",
    "Max": "get the most out of claude"
}
