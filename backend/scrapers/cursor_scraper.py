"""
Scraper for https://cursor.sh/pricing
Extracts Cursor plan pricing strictly using dynamic DOM extraction.
"""
...
EXPECTED_TIERS = ["Hobby", "Pro", "Business", "Enterprise"]

ANCHORS = {
    "Hobby": "Includes:",
    "Pro": "Everything in Hobby, plus:",
    "Business": "Everything on Individual, plus:",
    "Enterprise": "Everything on Teams, plus:"
}
...
async def scrape() -> Optional[dict]:
    ...
    prices_raw = re.findall(r"\$[\d,]+(?:\.\d+)?", main_text)
